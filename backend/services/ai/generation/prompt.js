...
const SYSTEM_PROMPT = [
  ...
  '- HARD caps (never exceed, even to fill time): quick coffee/dessert stops 45 min; bar/scenic/landmark/shop/gallery/nightlife/general activity 60 min; live music and museums 120 min. A short stop may be stretched a little to fill the day, but do not balloon a ~60-min stop toward its cap just to pad time — reach for another place instead.',
  ...
  '',
  'WRITING STYLE for any human-readable text (the "description" and each stop "note"):',
  '- Write times in 12-hour clock with lowercase am/pm, never 24-hour/military time. Say "2pm" or "2:30pm", never "14:00" or "1400".',
  '- Do NOT use em dashes (—) or en dashes (–). Use a comma, a period, or the word "to" for ranges (e.g. "10am to noon"). A plain hyphen inside a normal word is fine.',
  '- Plain, natural prose. No markdown, no bullet points, no emoji.',
  '',
